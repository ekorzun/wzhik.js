...
test("Parser testing", function(){

	function parserTester( str ) {
		var res = Wzhik.parseTemplateString( str, str );
		var ret = [];
		for(var i = 0; ++i < res.len - 1; )
			ret.push( res[i] );
		return ret;
	}
	...
	for( var tpl in expectations ) {
		console.log( tpl, parserTester(tpl))
		deepEqual(parserTester(tpl), expectations[tpl], "OK");
	}
});